...
date: 2020-06-09T12:05:00-04:00
...
```shell-session
$ sha256sum -c <(echo "aed845e4185a0b2a3c3d5e1d0a35491702c55889192bb9c30e67a3de6849c067  go1.14.4.linux-amd64.tar.gz")
go1.14.4.linux-amd64.tar.gz: OK
```
...
```shell-session
$ sha256sum -c <(echo "7011af3bbc2ac108d1b82ea8abb87b2e63f78844f0259be20cde4d42c5c40584  go1.14.4.src.tar.gz")
go1.14.4.src.tar.gz: OK
```
...
```shell-session
$ # Desde Google
$ git clone -b go1.14.4 https://go.googlesource.com/go
```

```shell-session
$ # Desde GitHub
$ git clone -b go1.14.4 https://github.com/golang/go
```
