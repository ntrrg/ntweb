...
date: 2020-05-23T14:05:00-04:00
...
```shell-session
$ sha256sum -c <(echo "a4d71ca9e02923fa96669a4b5faf78ee8331b18e7209b09dd87fe763b4838ada  go1.13.11.linux-amd64.tar.gz")
go1.13.11.linux-amd64.tar.gz: OK
```
...
```shell-session
$ wget https://dl.google.com/go/go1.13.11.src.tar.gz
```

```shell-session
$ sha256sum -c <(echo "89ed1abce25ad003521c125d6583c93c1280de200ad221f961085200a6c00679  go1.13.11.src.tar.gz")
go1.13.11.src.tar.gz: OK
```

```shell-session
$ tar -xf go1.13.11.src.tar.gz
```
...
```shell-session
$ # Desde Google
$ git clone -b go1.13.11 https://go.googlesource.com/go
```

```shell-session
$ # Desde GitHub
$ git clone -b go1.13.11 https://github.com/golang/go
```
